...
print(f'Height of Tree: {my_bst.height_of_tree(node01)}')
print(f'Size of Tree: {my_bst.size_of_tree(node01)}')
print(f'Is BST: {my_bst.is_bst(node01)}')
print(f'Min and Max: {my_bst.min_and_max_node(node01)}')
